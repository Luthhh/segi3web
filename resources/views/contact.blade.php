...
<head>
    ...
    <title>Kontak - Segitiga Motor</title>
...
<div class="body-wrapper">
                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            <h6 class="section-subtitle ltn__secondary-color">//  Selamat Datang di Kontak Kami</h6>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        ...
                        <h3>Alamat Email</h3>
                        <a href="mailto:Segitigamotor024@gmail.com">Segitigamotor024@gmail.com</a>
                    </div>
                </div>                
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        ...
                        <h3>Nomor Telepon</h3>
                        <a href="tel:+6285174296682">+62 851-7429-6682</a>
                    </div>
                </div>                
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        ...
                        <a href="https://maps.app.goo.gl/phfqpBZNSpFrdea46" target="_blank">Jl. Sukaraja - Katulampa, Sukaraja, ...</a>
                    </div>
                </div>                
            </div>
        </div>
                    ...
                    <div class="ltn__form-box contact-form-box box-shadow white-bg">
                        ...
                        <form id="contact-form" action="{{ route('contact.send') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-item input-item-motor ltn__custom-icon">
                                        <input type="text" name="motor_type" placeholder="Enter your motorcycle type" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
    ...
    </div>    <!-- CONTACT MESSAGE AREA END -->

    <!-- GOOGLE MAP AREA START -->
    <div class="google-map">
       
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.4394879548804!2d106.83651487406526!3d-6.592170393401526!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c66718774dbf%3A0x6619040709be47be!2sMotoXpress%20Segitiga%20Motor%20-%20Tiga%20Putra%20Motor%20II!5e0!3m2!1sen!2sid!4v1726900917907!5m2!1sen!2sid" width="100%" height="100%" frameborder="0" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
