...
<head>
    ...
    <title>Tips Perawatan Sepeda Motor yang Wajib Anda Lakukan</title>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-details-wrap">
                        <div class="ltn__page-details-inner ltn__blog-details-inner">
                            ...
                            <h2 class="ltn__blog-title">Tips Perawatan Sepeda Motor yang Wajib Anda Lakukan</h2>
                            <div class="ltn__blog-meta">
                                <ul>
                                    <li class="ltn__blog-author">
                                        <a><img src="img\blog\22.jpg" alt="#">Oleh Suzuki Indonesia</a>
                                    </li>
                            ...
                            <p>Di tengah sibuknya jalanan perkotaan yang kerap membuat kita terjebak dalam kemacetan berjam-jam membuat keberadaan sepeda motor jadi salah satu solusi paling efisien. Kemampuannya untuk gesit selap selip di tengah kemacetan jadi keunggulan utamanya. Sepeda motor juga merupakan alat transportasi harian paling praktis untuk bisa digunakan untuk bekerja, sekolah, kuliah atau bahkan hanya untuk sekadar jalan-jalan santai bersama keluarga maupun teman.</p>
                            <p>Agar kuda besi Anda tetap sehat dan terawat untuk bisa menemani perjalanan Anda sehari-hari, berikut adalah tips perawatan sepeda motor yang tak boleh Anda lewatkan.</p>
                            <img src="img\blog\22.jpg" alt="Image">
                            <h2>Jangan Sembarang Isi BBM</h2>
                            <p>Saat kondisi mendesak dan kehabisan bensin di tengah jalan, kadang ada pengendara motor yang terpaksa membeli BBM eceran di pinggir jalan karena tidak menemukan pom bensin terdekat. Tentunya hal ini harus dihindari oleh pemilik sepeda motor, karena BBM yang dijual tersebut belum tentu BBM murni. Menggunakan BBM oplosan beresiko membuat suara mesin jadi kasar, karenanya pastikan selalu mengisi BBM di SPBU yang sudah jelas kualitas dan keamanannya</p>
                            <h2>Rutin Ganti Oli Motor</h2>
                            <p>Oli motor menjaga mesin kendaraan agar selalu dalam keadaan bersih. Karena sering kali terjadi gesekan pada mesin yang memicu munculnya kotoran, maka oli yang tetap bagus kondisinya sangat diperlukan. Agar performa motor kesayangan Anda tetap terjaga, selalu pastikan untuk rutin mengganti oli setidaknya 2 minggu sekali atau setiap 500km agar mesin tetap awet.</p>
                            <h2>Menjaga Kondisi Ban</h2>
                            <p>Ban merupakan komponen yang tak kalah penting dari sepeda motor, karena benda inilah yang langsung bergesekan dengan medan jalanan saat Anda berkendara. Karenanya pastikan untuk selalu menjaga kondisi ban tetap prima sebelum Anda menggunakan sepeda motor Anda. Sesuaikan tekanan angin ban, jangan terlalu keras agar tidak mudah meletus dan juga tidak terlalu kempes agar ban tidak mudah benjol. Periksa juga ketebalan permukaan ban, jika tonjolan Thread Wire Indicator mulai menipis segeralah untuk menggantinya dengan yang baru.</p>
                            <h2>Cek Kondisi Aki</h2>
                            <p>Aki motor adalah jantungnya kendaraan Anda. Dia adalah pusat terpenting yang mengalirkan listrik pada seluruh komponen motor, karenanya selalu pastikan Anda mengecek kondisi aki apakah masih sehat atau sudah harus diservis dan diganti. Jangan sampai di tengah perjalanan, aki Anda soak dan motor jadi tidak bisa dipergunakan. Cara paling mudah mengecek aki motor adalah dengan diraba langsung menggunakan tangan. Aki yang soak biasanya permukaan atau casing aki akan terasa menonjol. Ini biasanya disebabkan karena panas yang disebabkan oleh elektrolit yang ada di dalam aki. Cara lain yang lebih akurat adalah menggunakan volt meter untuk mengetahui voltase pada aki, biasanya aki normal memiliki 12,4 volt. Jika setelah diukur aki kurang dari angka tersebut, sebaiknya segera ganti aki motor Anda.</p>
                            <h2>Rutin Tune Up Sepeda Motor</h2>
                            <p>Jangan hanya rutin memakai sepeda motor saja, Anda juga harus rutin melakukan tune up sepeda motor agar kendaraan kesayangan Anda senantiasa sehat terjaga. Pilih bengkel resmi yang terpercaya untuk melakukan tune up atau servis berkala seperti dealer Suzuki malang. Dapatkan pelayanan terbaik dari teknisi profesional yang akan membantu Anda melakukan pengecekan seluruh komponen sepeda motor serta kemudahan mendapatkan suku cadang sepeda motor yang 100% asli dan bergaransi.</p>
