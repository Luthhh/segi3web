                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-details-wrap">
                        <v class="ltn__page-details-inner ltn__blog-details-inner">
                            ...
                            <h2 class="ltn__blog-title">6 Hal Yang Harus Diperhatikan Saat Servis Motor</h2>
                            <div class="ltn__blog-meta">
                                <ul>
                                    <li class="ltn__blog-author">
                                        <a><img src="img/blog/23.jpg" alt="#">Oleh Wahana Honda</a>
                                    </li>
                            ...
                            <p>Memiliki sepeda motor yang selalu dalam kondisi prima merupakan keinginan setiap biker. Oleh karena itu, tidak jarang jika para biker ini selalu melakukan perawatan motor sederhana di rumah.  Namun tidak bisa dipungkiri, bahwa kita juga memerlukan bengkel untuk menangani masalah pada motor, baik itu hanya sekedar servis rutin ataupun penanganan kerusakan. Akan tetapi, perlu diingat bahwa ada kalanya penanganan bengkel tidak sempurna karena yang mengerjakan juga tangan manusia.</p>
                            <p>Nah, jika Anda ingin motor kesayangan ke bengkel, sebaiknya perhatikan hal-hal berikut ini agar selama pengerjaan motor kita ditangani dengan baik. Check these out!</p>
                            <img src="img\blog\23.jpg" alt="Image">
                            <h2>Komunikasi dengan mekanik</h2>
                            <p>Saat ke bengkel resmi, Anda akan ditanyakan mengenai keluhan–keluhan motor oleh pihak counter, yang berikutnya akan disampaikan kepada mekanik. Namun, tidak ada salahnya jika kita melakukan komunikasi langsung dengan mekanik agar penanganan motor sesuai dengan kebutuhan.</p>
                            <h2>Beda mekanik, beda style tuning</h2>
                            <p>Perlu dipahami bahwa setiap mekanik memiliki cara berbeda dalam menangani mesin motor. Jika kamu ingin motor kesayanganmu mendapat penanganan yang tepat, alangkah baiknya untuk memberikan penjelasan terlebih dahulu kepada mekanik mengenai gaya atau seleramu dalam mengendarai sepeda motor.</p>
                            <h2>Mekanik yang dikejar target</h2>
                            <p>Selama pengerjaan kerap kali kita melihat mekanik yang terburu-buru. Hal ini perlu dimaklumi karena sistem kerja di bengkel menuntut mekanik kerja cepat untuk menyelesaikan daftar antrean pelanggan. Jika kamu ingin motor kesayanganmu tetap mendapatkan sentuhan yang maksimal, sebaiknya sebelum mekanik memulai pengerjaan, beritahu keluhan atau poin-poin penting yang harus dikerjakan terlebih dahulu</p>
                            <h2>Tidak bisa memilih mekanik</h2>
                            <p>Jika melakukan servis ke bengkel umum langganan, Anda akan diberikan keuntungan untuk memilih mekanik yang menangani motor. Namun beda halnya saat Anda pergi ke bengkel resmi. Walau mekaniknya berbeda, kita tetap berhak mendapatkan pelayanan yang maksimal. Untuk itu, sampaikanlah keluhan dengan jelas agar mekanik melakukan penanganan yang tepat terhadap motor Anda. </p>
                            <h2>Dengarkan pendapat dari mekanik</h2>
                            <p>Walau menurut Anda keluhan motor hanya terjadi pada bagian tertentu, bukan berarti Anda mengabaikan info dari mekanik. Saat mekanik melakukan test drive sudah seharusnya Anda mendengar masukan dari mekanik. Terkadang, kita sebagai rider kurang peka terhadap gejala kerusakan motor. Untuk mencegah kerusakan menjalar, sebaiknya Anda menyerahkan masalah tersebut kepada mekanik.</p>
                            <h2>Sabar menunggu antrean</h2>
                            <p>Pada hari-hari tertentu biasanya bengkel selalu ramai. Hal ini wajar karena biasanya para biker melakukan servis motor pada akhir pekan. Antrean yayng panjang ini seringkali membuat kita ingin mekanik sesegera mungkin menyelesaikannya. Ingat, saat motor sudah masuk bengkel, Anda berhak mendapatkan pelayanan terbaik sehingga pentingnya kooperatif dengan kinerja mekanik</p>
                            <p>Setelah motor kesayangan diservis, cobalah untuk mengendarainya sehingga Anda tahu apakah kondisinya sudah kembali prima atau belum. Hal ini untuk memastikan bahwa penanganan terhadap motor sudah benar-benar maksimal. Enam hal di atas adalah hal yang harus diperhatikan saat servis motor kesayangan di bengkel. Semoga bermanfaat! </p>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="ltn__blog-item ltn__blog-item-6">
                                        <div class="ltn__blog-img">
                                            <a href="blog4"><img src="img\blog\24.jpg" alt="Image"></a>
                                        </div>
