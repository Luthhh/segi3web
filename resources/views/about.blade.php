...
<head>
    ...
    <title>About - Segitiga Motor</title>
                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            ...
                            <h1 class="section-title white-color">Tentang Kami</h1>
                        </div>
                    ...
                    <div class="about-us-img-wrap about-img-left">
                        ...
                        <div class="about-us-img-info about-us-img-info-2">
                            <div class="about-us-img-info-inner">
                                <h1>17<span>+</span></h1>
                                <h6>Pengalaman Bertahun - tahun</h6>
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-info-wrap">
                        ...
                        <div class="btn-wrapper">
                            <a href="service" class="theme-btn-3 btn btn-effect-4">SERVIS KAMI</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-7">
                        <div class="ltn__feature-icon-title">
                            ...
                            <h3><a href="service-details">All Kind Brand</a></h3>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-7">
                        <div class="ltn__feature-icon-title">
                            ...
                            <h3><a href="service-details">Brake Fluid Exchange</a></h3>
                        </div>
                        <div class="ltn__feature-info">
                            <p>Lorem ipsum dolor sit ame it, consectetur adipisicing elit, sed do eiusmod te mp or incididunt ut labore.</p>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-7">
                        <div class="ltn__feature-icon-title">
                            ...
                            <h3><a href="service-details">Maintenance Package</a></h3>
                        </div>
                        <div class="ltn__feature-info">
                            <p>Lorem ipsum dolor sit ame it, consectetur adipisicing elit, sed do eiusmod te mp or incididunt ut labore.</p>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="call-to-action-inner call-to-action-inner-5 text-center">
                        <h2 class="white-color text-decoration">24/7 Availability, Make <a href="booking">An booking</a></h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="ltn__blog-area pt-0 pb-90">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2 text-center">
                        <h1 class="section-title">Visi <span>&</span> Misi</h1>
                    </div>
                </div>
            </div>
            <div class="row ltn__blog-slider-one-active slick-arrow-1">
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-4 bg-image" data-bs-bg="">
                        <div class="ltn__blog-brief">
                            <h3 class="ltn__blog-title"><a href="blog-details">Visi</a></h3>
                            <p>1. Menjadi bengkel motor terkemuka dengan layanan berkualitas tinggi.</p>
                            <p>2. Berkomitmen pada praktik ramah lingkungan</p>
                            <p>3. Membangun kesadaran pelanggan melalui edukasi.</p>
                            <p>4. Menerapkan teknologi terbaru untuk efisiensi layanan.</p>
                            <p>5. Berpartisipasi aktif dalam komunitas lokal.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-4 bg-image" data-bs-bg="">
                        <div class="ltn__blog-brief">
                            <h3 class="ltn__blog-title"><a href="blog-details">Misi</a></h3>
                            <p>1. Menyediakan layanan perawatan motor yang profesional dan efektif.</p>
                            <p>2. Memiliki mekanik yang berpengalaman.</p>
                            <p>3. Menggunakan peralatan dan suku cadang berkualitas.</p>
                            <p>4. Selalu beradaptasi dengan perkembangan teknologi terbaru.</p>
                            <p>5. Memberikan pelayanan yang ramah dan responsif.</p>
                        </div>
                    </div>
                </div>
            </div>                       
