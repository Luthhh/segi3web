...
<head>
    ...
    <title>Servis - Segitiga Motor</title>
                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            <h6 class="section-subtitle ltn__secondary-color">//  Selamat Datang di Servis Kami</h6>
                            <h1 class="section-title white-color">Servis</h1>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 align-self-center">
                    <div class="about-us-info-wrap">
                        <div class="section-title-area ltn__section-title-2">
                            <h6 class="section-subtitle ltn__secondary-color">//  LAYANAN TERPERCAYA</h6>
                        ...
                        <div class="about-us-info-wrap-inner about-us-info-devide">
                            <p> Kepuasan Anda adalah tujuan utama kami. Setiap motor yang kami tangani diperlakukan dengan penuh perhatian, memastikan Anda meninggalkan bengkel kami dengan perasaan puas.</p>
                            <div class="list-item-with-icon">
                                <ul>
                                    <li><a>Tim Profesional</a></li>
                                    <li><a>Peralatan Berkualitas</a></li>
                                    <li><a>Kecepatan & Efisiensi</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2 text-center">
                        ...
                        <h1 class="section-title">Apa yang bisa kita lakukan <span>.</span></h1>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="ltn__service-item-2 white-bg">
                        ...
                        <div class="service-item-brief">
                            <h3>Servis CVT</h3>
                                <ul>
                                    <li>Pastikan motor matic Anda selalu prima dengan Servis CVT rutin. Cek dan ganti V-Belt, roller, dan komponen lainnya untuk akselerasi yang halus dan performa maksimal.</li>
                                </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ltn__service-item-2 white-bg">
                        ...
                        <div class="service-item-brief">
                            <h3>Servis Injeksi</h3>
                                <ul>
                                    <li>Jaga efisiensi dan performa motor injeksi Anda dengan Servis Injeksi berkala. Pembersihan dan penyetelan injektor memastikan pembakaran lebih sempurna dan hemat bahan bakar.</li>
                                </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="ltn__service-item-2 white-bg">
                        ...
                        <div class="service-item-brief">
                            <h3>Servis Karburator</h3>
                                <ul>
                                    <li>Pastikan motor Anda berjalan optimal dengan Servis Karburator. Kami membersihkan dan menyetel karburator untuk memastikan campuran bahan bakar dan udara ideal, meningkatkan performa, efisiensi bahan bakar, dan mengurangi emisi.</li>
                                </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="ltn__service-item-2 white-bg">
                        ...
                        <div class="service-item-brief">
                            <h3>Servis Throttle Body</h3>
                                <ul>
                                    <li>Tingkatkan performa mesin motor Anda dengan Servis Throttle Body. Kami membersihkan dan menyetel throttle body untuk memastikan aliran udara lancar, meningkatkan respons akselerasi, efisiensi bahan bakar, dan mengurangi emisi.</li>
                                </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ltn__service-item-2 white-bg">
                        ...
                        <div class="service-item-brief">
                            <h3>Overhaul Mesin</h3>
                                <ul>
                                    <li>Pembongkaran dan perbaikan menyeluruh pada mesin, termasuk penggantian komponen aus, pembersihan bagian dalam, dan penyetelan sistem. Layanan ini mengembalikan daya mesin, mengurangi kebisingan, dan meningkatkan efisiensi bahan bakar.</li>
                                </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="ltn__service-item-2 white-bg">
                        ...
                        <div class="service-item-brief">
                            <h3>Ganti Ban</h3>
                                <ul>
                                    <li>Kami menawarkan penggantian ban dengan berbagai merek dan ukuran sesuai kebutuhan motor Anda. Proses pemasangan dilakukan secara profesional, termasuk pengecekan tekanan dan penyetelan agar performa motor optimal. </li>
                                </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-4 bg-image" data-bs-bg="img/blog/1.jpg">
                        <div class="ltn__blog-brief">
                            ...
                            <h3 class="ltn__blog-title"><a href="blog-details">Electric Car Maintenance, Servicing & Repairs</a></h3>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-4 bg-image" data-bs-bg="img/blog/2.jpg">
                        <div class="ltn__blog-brief">
                            ...
                            <h3 class="ltn__blog-title"><a href="blog-details">Common Engine Oil Problems and Solutions</a></h3>
                            <p>Lorem ipsum labore et dolore mag na aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-4 bg-image" data-bs-bg="img/blog/3.jpg">
                        <div class="ltn__blog-brief">
                            ...
                            <h3 class="ltn__blog-title"><a href="blog-details">How to Prepare for your First Track Day!</a></h3>
                            <p>Lorem ipsum labore et dolore mag na aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-4">
                        <div class="ltn__blog-brief">
                            ...
                            <h3 class="ltn__blog-title"><a href="blog-details">How to: Make Your Tires Last Longer</a></h3>
                            <p>Lorem ipsum labore et dolore mag na aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
