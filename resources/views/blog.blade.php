        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        <div class="ltn__blog-img">
                            <a href="blog1"><img src="img\blog\21.jpg" alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
                                    <li class="ltn__blog-author">
                                      <a><i class="far fa-user"></i>oleh: detikOto</a>
                                    </li>
                                    <li class="ltn__blog-tags">
                                        <a><i class="fas fa-tags"></i>Servis</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                                        <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i>Agustus 14, 2021</li>
                                    </ul>
                                </div>
                    ...
                    <div class="ltn__blog-item ltn__blog-item-3">
                        ...
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
                                    <li class="ltn__blog-author">
                                        <a><i class="far fa-user"></i>oleh: Suzuki Indonesia</a>
                                    </li>
                                    <li class="ltn__blog-tags">
                                        <a><i class="fas fa-tags"></i>Servis</a>
                                    </li>
                    ...
                    <div class="ltn__blog-item ltn__blog-item-3">
                        ...
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
                                    <li class="ltn__blog-author">
                                        <a><i class="far fa-user"></i>oleh: Wahana Honda</a>
                                    </li>
                                    <li class="ltn__blog-tags">
                                        <a><i class="fas fa-tags"></i>Servis</a>
                                    </li>
                            ...
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                                        <li class="ltn__blog-date"><i ></i>Juli 7, 2018</li>
                                    </ul>
                                </div>
                                <div class="ltn__blog-btn">
                    ...
                    <div class="ltn__blog-item ltn__blog-item-3">
                        ...
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
                                    <li class="ltn__blog-author">
                                        <a><i class="far fa-user"></i>oleh: AstraOtoshop</a>
                                    </li>
                                    <li class="ltn__blog-tags">
                                        <a><i class="fas fa-tags"></i>Servis</a>
                                    </li>
                            ...
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                                        <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i>4 Juni, 2024</li>
                                    </ul>
                                </div>
                                <div class="ltn__blog-btn">
                    ...
                    <div class="ltn__blog-item ltn__blog-item-3">
                        ...
                        <div class="ltn__blog-brief">
                            ...
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                                        <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i>30 Oktober, 2018</li>
                                    </ul>
                                </div>
                                <div class="ltn__blog-btn">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        <div class="ltn__blog-img">
                            <a href="blog6"><img src="img\blog\26.jpg" alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
                                    <li class="ltn__blog-author">
                                        <a><i class="far fa-user"></i>oleh: PlanetBan</a>
                                    </li>
                                    <li class="ltn__blog-tags">
                                        <a><i class="fas fa-tags"></i>Servis</a>
                                    </li>
                            ...
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                                        <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i>17 Oktober, 2024</li>
                                    </ul>
                                </div>
                                <div class="ltn__blog-btn">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        <div class="ltn__blog-img">
                            <a href="blog7"><img src="img\blog\27.jpg" alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
                                    <li class="ltn__blog-author">
                                        <a><i class="far fa-user"></i>oleh: medcom.id</a>
                                    </li>
                                    <li class="ltn__blog-tags">
                                        <a><i class="fas fa-tags"></i>Servis</a>
                                    </li>
                            ...
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                                        <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i>20 November, 2023</li>
                                    </ul>
                                </div>
                                <div class="ltn__blog-btn">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        <div class="ltn__blog-img">
                            <a href="blog8"><img src="img\blog\28.jpg" alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
                                    <li class="ltn__blog-author">
                                        <a><i class="far fa-user"></i>oleh: Speedwork Autocare</a>
                                    </li>
                                    <li class="ltn__blog-tags">
                                        <a ><i class="fas fa-tags"></i>Servis</a>
                                    </li>
                            ...
                            <h3 class="ltn__blog-title"><a href="blog8">Apa yang harus Dilakukan Ketika Tune Up pada Mesin Motor?</a></h3>
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                                        <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i>26 Desember, 2019</li>
                                    </ul>
                                </div>
                                <div class="ltn__blog-btn">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        <div class="ltn__blog-img">
                            <a href="blog9"><img src="img\blog\29.jpg" alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
                            ...
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                                        <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i>27 September, 2022</li>
                                    </ul>
                                </div>
                                <div class="ltn__blog-btn">
